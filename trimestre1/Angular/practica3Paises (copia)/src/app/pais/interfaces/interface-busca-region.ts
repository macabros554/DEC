...
//
//   const interfaceBuscaRegion = Convert.toInterfaceBuscaRegion(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface InterfaceBuscaRegion {
  name:         Name;
  tld?:         string[];
  cca2:         string;
  ccn3?:        string;
...
export class Convert {
  public static toInterfaceBuscaRegion(json: string): InterfaceBuscaRegion[] {
      return cast(JSON.parse(json), a(r("InterfaceBuscaRegion")));
  }

  public static interfaceBuscaRegionToJson(value: InterfaceBuscaRegion[]): string {
      return JSON.stringify(uncast(value, a(r("InterfaceBuscaRegion"))), null, 2);
  }
}
