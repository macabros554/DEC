...
//
//   const interfaceBuscaCapital = Convert.toInterfaceBuscaCapital(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface InterfaceBuscaCapital {
  name:         Name;
  tld:          string[];
  cca2:         string;
  ccn3:         string;
...
export class Convert {
  public static toInterfaceBuscaCapital(json: string): InterfaceBuscaCapital[] {
      return cast(JSON.parse(json), a(r("InterfaceBuscaCapital")));
  }

  public static interfaceBuscaCapitalToJson(value: InterfaceBuscaCapital[]): string {
      return JSON.stringify(uncast(value, a(r("InterfaceBuscaCapital"))), null, 2);
  }
}
