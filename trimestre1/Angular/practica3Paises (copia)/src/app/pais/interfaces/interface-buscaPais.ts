...
//
//   const interfaceBuscaPais = Convert.toInterfaceBuscaPais(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface InterfaceBuscaPais {
  name:         Name;
  tld:          string[];
  cca2:         string;
  ccn3:         string;
...
export class Convert {
  public static toInterfaceBuscaPais(json: string): InterfaceBuscaPais[] {
      return cast(JSON.parse(json), a(r("InterfaceBuscaPais")));
  }

  public static interfaceBuscaPaisToJson(value: InterfaceBuscaPais[]): string {
      return JSON.stringify(uncast(value, a(r("InterfaceBuscaPais"))), null, 2);
  }
}
