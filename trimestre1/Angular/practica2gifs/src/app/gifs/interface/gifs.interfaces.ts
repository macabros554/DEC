// To parse this data:
//
//   import { Convert, Gifs } from "./file";
//
//   const gifs = Convert.toGifs(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SeartGifInteface {
  data:       Gif[];
...
export class Convert {
  public static toGifs(json: string): SeartGifInteface {
      return cast(JSON.parse(json), r("Gifs"));
  }

  public static gifsToJson(value: SeartGifInteface): string {
      return JSON.stringify(uncast(value, r("Gifs")), null, 2);
  }
}
